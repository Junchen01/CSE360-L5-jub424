...
target_list = points_in_circle(5.45,0,1)
...
try:
    while is_running:
        if robot_id in positions:
            ...
            if distance < 0.1 and target_list_at < target_list_len:
                target = target_list[target_list_at]
                target_list_at += 1
                # print('point change to: ' + target)
            elif  distance < 0.1 and target_list_at == target_list_len:
                break
